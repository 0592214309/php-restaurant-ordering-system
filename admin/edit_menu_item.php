...
<head>
    ...
    <style>
        ...
        .preview-img { max-width: 120px; max-height: 120px; border-radius: 8px; margin-bottom: 1rem; }
    </style>
</head>
<body>
    <?php include '../includes/navbar.php'; ?>
    <div class="form-container">
        <div class="form-header">Edit Menu Item</div>
        <?php if ($message): ?>
        ...
        <form method="POST" enctype="multipart/form-data">
                ...
                <select id="category_id" name="category_id" required>
                    ...
                    <?php if ($cat_result && $cat_result->num_rows > 0): ?>
                        <?php while ($cat = $cat_result->fetch_assoc()): ?>
                            <option value="<?php echo $cat['category_id']; ?>" <?php echo ($cat['category_id'] == $item['category_id']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($cat['category_name']); ?></option>
                        <?php endwhile; ?>
                    <?php endif; ?>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <?php if ($item['image_url']): ?>
                    <img src="../<?php echo htmlspecialchars($item['image_url']); ?>" class="preview-img" alt="Current image">
                <?php endif; ?>
